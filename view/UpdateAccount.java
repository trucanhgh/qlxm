...
public class UpdateAccount extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtfullname, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, 298, 38));

        jLabel3.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 16)); // NOI18N
        jLabel3.setText("Tên đăng nhập");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 140, 24));

        txtusername.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 12)); // NOI18N
        jPanel1.add(txtusername, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 150, 298, 38));

        jLabel5.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 16)); // NOI18N
        jLabel5.setText("Vai trò");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, 70, -1));

        vaitro.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 16)); // NOI18N
        ...
        jPanel1.add(vaitro, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 280, 150, 38));

        btnupdate.setBackground(new java.awt.Color(146, 154, 171));
        btnupdate.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 16)); // NOI18N
        ...
        jPanel1.add(btnupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 370, 140, 38));

        btnClose.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 16)); // NOI18N
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 370, 140, 38));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 290, 90, -1));

        trangthai.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 16)); // NOI18N
        ...
        jPanel1.add(trangthai, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 280, 160, 38));
        ...
        jPanel1.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 300, 40));
